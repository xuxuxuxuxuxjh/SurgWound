...
edema_processed_list = []
image_path = ''
for data in edema_list:
...
print(len(edema_processed_list))
...
def print_statistics(field_stats, results, TP, FP, FN):
    ...
    # 保存详细结果到文件
    # with open('eval_edema.json', 'w', encoding='utf-8') as f:
    #     json.dump({
    ...
    # print(f"\nDetailed results saved to 'eval_edema.json'")
