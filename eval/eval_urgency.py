...
image_path = '/fs/ess/PCON0023/xjh/data/wound_last_image/'
    ...
    with torch.no_grad():
        for i, sample in enumerate(dataset):
            ...
            try:
                ...
                correct_answer = row['Urgency Level']
...
def print_statistics(field_stats, results, TP, FP, FN):
    ...
    # 保存详细结果到文件
    with open('eval_urgency.json', 'w', encoding='utf-8') as f:
        json.dump({
    ...
    print(f"\nDetailed results saved to 'eval_urgency.json'")
