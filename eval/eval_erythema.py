...
erythema_processed_list = []
image_path = ''
for data in erythema_list:
    ...
    erythema_processed_list.append(
        {
            "messages": [
                {
...
print(len(erythema_processed_list))
...
def print_statistics(field_stats, results, TP, FP, FN):
    ...
    # 保存详细结果到文件
    # with open('eval_erythema.json', 'w', encoding='utf-8') as f:
    #     json.dump({
    ...
    # print(f"\nDetailed results saved to 'eval_erythema.json'")
