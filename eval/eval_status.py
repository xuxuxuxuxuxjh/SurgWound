...
print(len(status_processed_list))
    ...
    with torch.no_grad():
        for i, sample in enumerate(dataset):
            ...
            try:
                ...
                question = f"What is the wound status of this surgical wound?"
...
def print_statistics(field_stats, results, TP, FP, FN):
    ...
    # 保存详细结果到文件
    # with open('eval_status.json', 'w', encoding='utf-8') as f:
    #     json.dump({
    ...
    # print(f"\nDetailed results saved to 'eval_status.json'")
